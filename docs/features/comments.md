...
### Structured-viewer entry points (iter 7)

Three viewers gained inline comment-authoring affordances in iter 7 so structured documents are commentable at the same granularity that they're displayed:
