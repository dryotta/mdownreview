...
|----|------|----------|------|-----------|--------|-------|------|------------------|-------------------|--------|
| bug-rust-emit-comments-changed | Fix Rust mutation commands to emit comments-changed event | P1 | bug | yes | product, react-tauri, architect, security | src-tauri/src/commands.rs | low | yes | yes | open |
